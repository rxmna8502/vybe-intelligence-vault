...
- **[AI Coding Agents](../ai-coding-agents/README.md)** (5067 files): Coding agents, AI IDEs, software engineering agents, and repository workflows for AI-assisted development.
...
- **[Agent Frameworks](../agent-frameworks/README.md)** (5168 files): Frameworks and examples for tool calling, agent orchestration, and multi-agent systems.
- **[AI Browser and Computer Use](../ai-browser-computer-use/README.md)** (5832 files): Browser agents, computer-use agents, Playwright automation, Selenium automation, web navigation agents, and UI automation.
